<h1 align="center">LOADING ANIMATION</h1>
<h3 align="center">LOADING ANIMATION | HTML & CSS</h3>
...
[Download the ZIP from this location](https://github.com/ElZunayr/loading-animation.git), or run the following [git](https://git-scm.com/downloads) command to clone the files to your machine:
```bash
git clone https://github.com/ElZunayr/loading-animation.git
```
